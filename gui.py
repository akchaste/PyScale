...
file_tree.grid(column = 0, row = 3, padx = 5, pady = 5)
...
def plot_selected():
    ...
    try:
        ...
        plt.plot(data[:,0], data[:,1], label = selected_file)
        plt.legend()
...
refresh_directory = Button(file_browser, text = 'Refresh directory', width = 22, command = lambda: scan_output(0, output_location))
...
plot_selected.grid(column = 0, row = 1, padx = 5, pady = 5)

divider(file_browser, 200).grid(column = 0, row = 2, padx = 5, pady = 5)
